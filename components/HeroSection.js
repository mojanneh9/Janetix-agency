...
export default function HeroSection() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-black text-white px-6">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-purple-800 via-transparent to-blue-800 opacity-50 animate-pulse" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(128,0,128,0.3),_transparent)] opacity-40" />
      ...
      >
        <h1 className="text-6xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-purple-500 to-blue-500 text-transparent bg-clip-text drop-shadow-lg">
        ...
        <div className="mt-6 flex gap-4 justify-center">
          <motion.a
            ...
            className="px-6 py-3 text-lg font-semibold bg-purple-500 rounded-xl shadow-lg hover:bg-purple-600 transition-all backdrop-blur-lg bg-opacity-70"
          >
            Get Started
          </motion.a>
          <motion.a
            href="#portfolio"
            whileHover={{ scale: 1.1 }}
            className="px-6 py-3 text-lg font-semibold border border-gray-300 rounded-xl hover:bg-gray-800 transition-all backdrop-blur-lg bg-opacity-70"
          >
            View Portfolio
          </motion.a>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                key={index}
                className="p-6 bg-gray-900 rounded-xl shadow-lg hover:shadow-purple-500/50 transition-all backdrop-blur-lg"
